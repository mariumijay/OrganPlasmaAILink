...
export async function POST(request: NextRequest) {
  try {
    ...
    const isTestAccount = data.contact_email.toLowerCase() === 'test-hospital@gmail.com';
    ...
    const { data: authData, error: authError } = await adminSupabase.auth.admin.createUser({
      ...
      user_metadata: {
        ...
        approval_status: isTestAccount ? 'verified' : 'pending',
        is_verified: isTestAccount
      }
    });
