            ...
            <tbody className="divide-y divide-border/50">
              {filteredDonors.map((d, i) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span className={`px-2.5 py-1 rounded-full text-[9px] font-black uppercase tracking-wider border ${d.type === 'blood'
                  ...
                  <td className="px-6 py-4">
                    <div className="flex flex-col gap-1">
                      <button
                        ...
                        className={`flex items-center gap-2 text-[10px] font-black uppercase tracking-widest transition-all ${d.is_available ? 'text-green-500' : 'text-muted-foreground opacity-50'
                          }`}
                      >
            ...
            >
              ...
              <div className="p-8 border-t border-border bg-muted/20 flex gap-4">
                <button
                  ...
                  className={`flex-1 py-4 rounded-2xl font-black text-xs uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 ${selectedDonor.is_available ? 'bg-destructive text-white shadow-lg shadow-destructive/20' : 'bg-green-500 text-white shadow-lg shadow-green-500/20'
                    }`}
                >
