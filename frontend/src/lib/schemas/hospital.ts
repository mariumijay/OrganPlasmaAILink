...
export const hospitalFormSchema = z.object({
  ...
  hospital_type: z.enum(["Public", "Private", "Military", "Non-Profit", "NGO"]),
  ...
  latitude: z.number({
    required_error: "Location required — use Auto Detect button",
    invalid_type_error: "Please use Auto Detect or Search to set your location"
  }).min(20, "Latitude out of Pakistan range").max(40, "Latitude out of Pakistan range"),
  longitude: z.number({
    required_error: "Location required — use Auto Detect button",
    invalid_type_error: "Please use Auto Detect or Search to set your location"
  }).min(60, "Longitude out of Pakistan range").max(80, "Longitude out of Pakistan range"),
